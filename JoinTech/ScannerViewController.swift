...
class ScannerViewController: UIViewController, AVCaptureMetadataOutputObjectsDelegate {
    ...
    override func viewDidLoad() {
        ...
        do {
            ...
            videoPreviewLayer?.frame = CGRect(x: view.layer.bounds.minX, y: view.layer.bounds.minY + 100, width: view.layer.bounds.width, height: view.layer.bounds.height-100)
    ...
    @IBAction func backButton(_ sender: Any) {
        captureSession?.stopRunning()
        performSegue(withIdentifier: "scanToDoctor", sender: self)
    }
